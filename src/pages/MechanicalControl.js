...
const MechanicalControl = () => {
    ...
    useEffect(() => {
        context.set_mechanical_tankLevelPx(context.mechanical_tankLevel * config.parameters.render.m2Px);

        // context.set_pointPlatoonPx([context.pointPlatoonPx[0], 620 - context.mechanical_tankLevelPx - context.mechanicalParameters.pontoonHeightPx]);
        context.set_pointPlatoonPx([context.pointPlatoonPx[0], 400 ]);
    ...
    return (
        ...
        <div style={{
            ...
            <FluidTank flow={context.mechanical_tankFlowInp / context.manualController.parameters.tankFlowInpMax * 100}
                       level={context.mechanical_tankLevelPx}/>
